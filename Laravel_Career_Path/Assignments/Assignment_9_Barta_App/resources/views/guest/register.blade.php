        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <form class="space-y-6" action="{{ route('register-submit') }}" method="POST" novalidate>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="firstname" name="firstname" type="text" autocomplete="firstname" placeholder="Ashiqur"
                            value="{{ old('firstname') }}"
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="lastname" name="lastname" type="text" autocomplete="lastname" placeholder="Rahman"
                            value="{{ old('lastname') }}"
