    ...
    <main class="container mx-auto mt-8 min-h-screen max-w-2xl space-y-8 px-2">
        ...
        <section
            ...
            <div class="flex flex-col items-center justify-center gap-4 text-center">
                <!-- Avatar -->
                <div class="relative">
                    <img class="h-32 w-32 rounded-full border-2 border-gray-800" src="{{ $user->profile_picture_img }}"
                        alt="{{ $user->profile_picture_img }}" />
                    <!--            <span class="absolute bottom-2 right-4 h-3.5 w-3.5 rounded-full border-2 border-white bg-green-400 dark:border-gray-800"></span>-->
                </div>
                <!-- /Avatar -->
                <!-- User Meta -->
                <div>
            ...
            <div class="flex flex-row items-center justify-center gap-16 text-center">
                ...
                <div class="flex flex-col items-center justify-center">
                    <h4 class="font-bold sm:text-xl">{{ $postsByUser->count() }}</h4>
                    <p class="text-gray-600">Posts</p>
                </div>

                <!-- Total Comments Count -->
                <div class="flex flex-col items-center justify-center">
                    <h4 class="font-bold sm:text-xl">{{ $commentsCountByUser }}</h4>
