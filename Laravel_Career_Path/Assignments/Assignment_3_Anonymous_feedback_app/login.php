    ...
    if (empty($errorBag)) {
        ...
        if (file_exists($file_path) && filesize($file_path) > 0) {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                $_SESSION['user_uniqueid'] = $user['unique_id'];
                ...
                <div class="mx-auto max-w-xl">
                    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                        ...
                        <div class="mt-10 mx-auto w-full max-w-xl">
                            ...
                            if ($success_message) :
                            ?>
                                <div class="mt-2 mb-2  bg-teal-100 border border-teal-200 text-sm text-teal-800 rounded-lg p-3 dark:bg-teal-800/10 dark:border-teal-900 dark:text-teal-500" role="alert">
                            ...
                            if ($error_message) :
                            ?>
                                <div class="mt-2 mb-2  bg-red-100 border border-red-200 text-sm text-red-800 rounded-lg p-3 dark:bg-red-800/10 dark:border-red-900 dark:text-red-500" role="alert">
