...
if (empty($userid)) {
    flash('error', 'Invalid Feedback Form Link.<br>  Please Check Again');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($_POST['feedback'])) {
        $errorBag['feedback'] = 'Please Write A Message First';
    } else {
        ...
        if (file_exists($file_path)) {
            ...
            $feedbacks[] = ['user_unique_id' => $userid, 'feedback_content' => $feedback];
            ...
            <div class="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
                <div class="mx-auto max-w-xl">
                    ...
                    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
                        ...
                        if ($error_message) :
                        ?>
                            <div class="mt-2 mb-2  bg-red-100 border border-red-100 text-sm text-red-800 rounded-lg p-6 dark:bg-red-800/10  dark:text-red-500 text-center" role="alert">
                        ...
                        ?>
                            ...
                            <div class="mt-2 mx-auto w-full max-w-xl">
                                <form class="space-y-6" action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" novalidate>
                                    ...
                                    <div>
                                        ...
                                        <?php if (isset($errorBag['feedback'])) : ?>
                                            <p class="text-xs text-red-600 mt-1"> * <?= $errorBag['feedback'] ?></p>
                                        <?php endif; ?>
                                    </div>
