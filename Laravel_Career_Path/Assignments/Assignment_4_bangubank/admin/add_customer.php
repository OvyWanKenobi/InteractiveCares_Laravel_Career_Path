...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($fname && $lname) {
    ...
    $file_path = "../File/customers.json";
    $customerRegister = new Registration($file_path);

    if ($customerRegister->register($name, $email, $password)) {

      flash('success', 'Account Created Successfully. Please login.');
      header('Location: add_customer.php');
      exit;
    } else {
      $errorBag = $customerRegister->errorBag;
    }
  } else {
    $errorBag['name'] = 'Provide both First and Last name';
  }
}
                ...
                <div>
                  <button
                    ...
                    <span
                      ...
                      <span class="font-medium leading-none text-sky-700">A</span>
                    </span>
                    <!-- <img
      ...
      <div class="px-4 pb-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg">
          ...
          <form method="POST" action="<?= $_SERVER['PHP_SELF'] ?>"
            class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2" novalidate>
