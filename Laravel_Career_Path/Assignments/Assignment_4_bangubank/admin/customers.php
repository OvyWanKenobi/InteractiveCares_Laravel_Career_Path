...
$allCustomers = (new AccountInfo)->getAllCustomersInfo();
                    ...
                    <li
                      ...
                      <div class="flex gap-x-4">
                        ...
                        <span
                          ...
                          <span
                            class="text-xl font-medium leading-none text-white"><?= $name_parts[0][0] . $name_parts[1][0] ?></span>
                        </span>

                        <div class="flex-auto min-w-0">
                          <p
                            class="text-sm font-semibold leading-6 text-gray-900">
                            <a href="./customer_transactions.php?customer_id=<?= $customerId ?>">
                              <span
                          ...
                          <p class="flex mt-1 text-xs leading-5 text-gray-500">
                            <a
                              href="./customer_transactions.php?customer_id=<?= $customerId ?>"
                              class="relative truncate hover:underline"><?= $customerEmail ?></a>
                          </p>
                        </div>
                      </div>
                    </li>
