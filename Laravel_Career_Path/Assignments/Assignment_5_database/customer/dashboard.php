...
$myTransactions = $transactions->getCustomerTransactions();
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                      ...
                      <?php foreach ($myTransactions as $transaction) : ?>
                        <tr>
                          ...
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium <?= ($transaction['type'] === 'credit') ? 'text-emerald-600' : 'text-red-600'; ?>">
                            <?php echo (($transaction['type'] === 'credit') ? '+$' : '-$') . $transaction['amount'] ?>
                          </td>
                          <td
