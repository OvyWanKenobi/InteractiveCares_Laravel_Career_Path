...
$customer_transactions = $transactions->getCustomerTransactions();
...
<head>
  ...
  <title>Transactions of <?= $customer_name ?></title>
</head>
            ...
            <div class="sm:flex sm:items-center">
              <div class="sm:flex-auto">
                <p class="mt-2 text-sm text-gray-700">
                  List of transactions made by <?= $customer_name ?> .
                </p>
              </div>
            </div>
